...
export const getAboutProps = (): AboutProps | null => {
  return {
  "title": "Sobre Inmobiliaria XYZ",
  "subtitle": "Cada día más hogares encontrados en León",
  "content": "En XYZ, creemos que la decision de comprar una vivienda es fundamental. Es por esto por lo que queremos acompañarte en tu experiencia de la mano.",
