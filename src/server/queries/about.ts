...
export const getAboutProps = (): AboutProps | null => {
  ...
  "content": "En BestHouse, creemos que la decision de comprar una vivienda es fundamental. Es por esto por lo que queremos acompañarte en tu experiencia de la mano.",
