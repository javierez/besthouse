        ...
        <div className="rounded-md bg-muted p-4">
          ...
          <div className="grid grid-cols-1 gap-2 text-sm md:grid-cols-2">
            ...
            {data.economicInfo.gastosComunitarios && (
              <div>
                <span className="font-medium">Gastos de Comunidad:</span>{" "}
        ...
        <div className="flex items-start space-x-2">
          ...
          <div className="grid gap-1.5 leading-none">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="/terminos-condiciones-venta" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
                términos y condiciones
              </Link>{" "}
              y la{" "}
              <Link href="/proteccion-de-datos" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
